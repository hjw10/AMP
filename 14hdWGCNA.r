...
#setwd("/public/workspace/stu21230110/design/06hdWGCNA/B_cells")
setwd("/public/workspace/stu21230110/design/06hdWGCNA/Epithelial_cells")
#scRNA<-subset(scRNA_harmony,singleRnew=="Macrophage")
#scRNA<-subset(scRNA_harmony,singleRnew=="Stromal_cells")
#scRNA<-subset(scRNA_harmony,singleRnew=="B_cells")
scRNA<-subset(scRNA_harmony,singleRnew=="Epithelial_cells")
...
#  group_name = "Stromal_cells",
  group_name = "Epithelial_cells",# 选择感兴趣恶的细胞类群！
...
saveRDS(seurat_obj, file='hdWGCNA_object_Epithelial_cells.rds')
seurat_obj = readRDS("hdWGCNA_object_Epithelial_cells.rds")
...
pdf("12EnrichrBarPlot.pdf", height=9, width=8)
EnrichrDotPlot(
  seurat_obj,
  mods = c("brown","blue","magenta"), # use all modules (this is the default behavior)
...
pdf("13EnrichrBarPlot.pdf", height=9, width=8)
EnrichrDotPlot(
  seurat_obj,
  mods =  c("brown","blue","magenta"), # use all modules (this is the default behavior)
...
pdf("14EnrichrBarPlot.pdf", height=9, width=8)
EnrichrDotPlot(
  seurat_obj,
  mods = c("brown","blue","magenta"), # use all modules (this is the default behavior)
